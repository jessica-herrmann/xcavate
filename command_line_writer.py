...
'amount_up': 7, # Amount to raise nozzles in z-direction before switching the inactive/active nozzles, in mm --> Default is 10
'num_decimals': 8, # Number of decimals places for rounding output values
...
'custom': 1, # Including custom g-code? 1=Yes, 0=No
...
# Optional Parameters
include_optional = {
'tolerance': 5, # Amount of tolerance, in mm (see explanation of tolerance in README) --> Default is 0
...
'scale_factor': 1.8, # Multiple by which to scale the input network --> Default is 1
...
'printhead_1': 'B', # Name of printhead holding arterial ink --> Default is Aa
'printhead_2': 'C', # Name of printhead holding venous ink --> Default is Ab
'axis_1': 'Z', # Name of z-axis holding arterial ink --> Default is A
'axis_2': 'A', # Name of z-axis holding venous ink --> Default is B
...
'offset_x': 30.60, # Distance between the printhead nozzles in x for multimaterial, in mm --> Default is 103
'offset_y': 0.40, # Distance between the printhead nozzles in y for multimaterial, in mm --> Default is 0.5
