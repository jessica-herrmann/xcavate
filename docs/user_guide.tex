...
\gui{Overlap algorithm} & select & Retrace & ``Retrace'' scans all previous passes for shared nodes and retraces backwards to add overlap. \\
...
\begin{xltabular}{\textwidth}{L{4cm} L{2cm} X}
\toprule
...
\begin{xltabular}{\textwidth}{L{4.5cm} X}
\toprule
